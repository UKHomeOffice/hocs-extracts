...
import static uk.gov.digital.ho.hocs.extracts.service.domain.EventType.STAGE_ALLOCATED_TO_TEAM;
import static uk.gov.digital.ho.hocs.extracts.service.domain.EventType.STAGE_ALLOCATED_TO_USER;
import static uk.gov.digital.ho.hocs.extracts.service.domain.EventType.STAGE_COMPLETED;
import static uk.gov.digital.ho.hocs.extracts.service.domain.EventType.STAGE_CREATED;
import static uk.gov.digital.ho.hocs.extracts.service.domain.EventType.STAGE_RECREATED;
import static uk.gov.digital.ho.hocs.extracts.service.domain.EventType.STAGE_UNALLOCATED_FROM_USER;

@Service
public class AllocationExportService extends DynamicExportService {

    private static final String[] EVENTS = { STAGE_ALLOCATED_TO_TEAM, STAGE_CREATED, STAGE_RECREATED,
            STAGE_COMPLETED, STAGE_ALLOCATED_TO_USER, STAGE_UNALLOCATED_FROM_USER };

    public AllocationExportService(ObjectMapper objectMapper, AuditRepository auditRepository, InfoClient infoClient,
    ...
    protected String[] getHeaders() {
        return new String[]{
                "timestamp", "event", "userId", "caseUuid", "stage", "allocatedTo", "deadline"
        };
    }
