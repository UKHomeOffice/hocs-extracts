...
public class CaseNoteExportServiceTest extends BaseExportServiceTest{

    @Autowired
    private CaseNoteExportService caseNoteExportService;
    ...
    public void shouldReturnExport() throws IOException {
        caseNoteExportService.export(LocalDate.of(2020, 1, 1), LocalDate.now().plusDays(1),
