...
public class AppealExportServiceTest extends BaseExportServiceTest{

    @Autowired
    private AppealExportService appealExportService;
    ...
    public void shouldReturnExport() throws IOException {
        ...
        Assertions.assertEquals(14, headers.length);
